...
public class DMaaPConfigurationParserTest {
    ...
    public void testParseGen2() {
        ...
        assertThat(withEventsSegment.topic()).isEqualTo("DCAE-REST-CONF-COLLECTOR-EVENTS-DEV");
        ...
        assertThat(withOtherSegment.topic()).isEqualTo("DCAE-REST-CONF-COLLECTOR-EVENTS-DEV");
    }
    ...
    public void testParseLegacy() {
        ...
        assertThat(urlFirstThenHosts.topic()).isEqualTo("DCAE-REST-CONF-COLLECTOR-EVENTS-DEV");
        ...
        assertThat(urlKeyMissing.topic()).isEqualTo("DCAE-REST-CONF-COLLECTOR-EVENTS-DEV");
        ...
        assertThat(urlIsMissing.topic()).isEqualTo("DCAE-REST-CONF-COLLECTOR-EVENTS-DEV");
    }
}
